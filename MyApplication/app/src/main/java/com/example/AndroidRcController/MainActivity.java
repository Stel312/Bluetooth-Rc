...
import com.example.AndroidRcController.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fab.setOnClickListener((view) ->
                bs = new BluetoothScan(getApplicationContext(), bluetoothManager.getAdapter()));
    }
